...
> **相关文档**：[Canvas 绘制与 Block 布局](canvas-drawing.md) | [系统 API 参考](system-api.md)
...
> Canvas 绘制（DisplayList）、Block 语义层和 LayoutEngine 已移至 [canvas-drawing.md](canvas-drawing.md)。